...
<AccordionGroup>
  ...
  <Accordion title="Insufficient balance for storage fee">
    Top up your wallet with more 0G tokens. For testnet, use [faucet.0g.ai](https://faucet.0g.ai). For a rough estimate, 1 OG covers a few hundred kilobytes of storage.
  </Accordion>
